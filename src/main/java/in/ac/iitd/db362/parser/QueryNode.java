...
public class QueryNode {
    ...
    public QueryNode(Operator operator, String attribute, String value) {
    ...
    public QueryNode(Operator operator, QueryNode left, QueryNode right) {
        this.operator = operator;
        this.left = left;
        this.right = right;
    }
    ...
    public QueryNode(Operator operator, QueryNode node) {
        this.operator = operator;
        this.left = node;
    }
}
